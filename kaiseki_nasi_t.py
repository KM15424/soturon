...
kyoku = 0
dir_path = './tenhou_paihu'
dir_path2 = './tenhou_csv'
tenhou = 4
...
if int(len(files2)) > 199:
    sys.exit()
csv = './tenhou_csv/' + 'tenhou' + str(count0) + 'c.csv'
df = pd.DataFrame([],columns = ['tsumo','mae','ato','kazu'],index = ['1'])
df
df.to_csv(csv)
count = 0
count2 = 0
...
for file in files:
    ...
    with open (file_path, encoding="utf-8") as f:
        ...
        #いらない部分を削除
        paihu = f.read()
        if name := re.search('n0=\"%E3%82%A6%E3%83%AB%E3%83%88%E3%83%A9%E7%AB%8B%E7%9B%B4\"',paihu):
            tenhou = 0
        elif name := re.search('n1=\"%E3%82%A6%E3%83%AB%E3%83%88%E3%83%A9%E7%AB%8B%E7%9B%B4\"',paihu):
            tenhou = 1
        elif name := re.search('n2=\"%E3%82%A6%E3%83%AB%E3%83%88%E3%83%A9%E7%AB%8B%E7%9B%B4\"',paihu):
            tenhou = 2
        elif name := re.search('n3=\"%E3%82%A6%E3%83%AB%E3%83%88%E3%83%A9%E7%AB%8B%E7%9B%B4\"',paihu):
            tenhou = 3
        else:
            break
                ...
                if paihu[0:2] == "<T" or (paihu[0:2] == "<U" and paihu[0:3] != "<UN") or paihu[0:2] == "<V" or paihu[0:2] == "<W" or paihu[0:2] == "<D" or paihu[0:2] == "<E" or paihu[0:2] == "<F" or paihu[0:2] == "<G": 
                    ...
                    if act_eng == 'T':
                        ...
                        if hai2 < 9:
                            ...
                            if tenhou == 0:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai_m,tehai_m2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 0:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai_p,tehai_p2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 0:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai_s,tehai_s2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 0:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai_j,tehai_j2,'1']
                                df.to_csv(csv)
                        ...
                        if hai2 < 9:
                            ...
                            if tenhou == 1:
                                count += 1             
                                df.loc[str(count)] = [tsumohai,tehai1_m,tehai1_m2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 1:
                                count += 1                  
                                df.loc[str(count)] = [tsumohai,tehai1_p,tehai1_p2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 1:
                                count += 1               
                                df.loc[str(count)] = [tsumohai,tehai1_s,tehai1_s2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 1:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai1_j,tehai1_j2,'1']
                                df.to_csv(csv)
                        ...
                        if hai2 < 9:
                            ...
                            if tenhou == 2:
                                count += 1               
                                df.loc[str(count)] = [tsumohai,tehai2_m,tehai2_m2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 2:
                                count += 1                 
                                df.loc[str(count)] = [tsumohai,tehai2_p,tehai2_p2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 2:
                                count += 1                  
                                df.loc[str(count)] = [tsumohai,tehai2_s,tehai2_s2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 2:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai2_j,tehai2_j2,'1']
                                df.to_csv(csv)
                        ...
                        if hai2 < 9:
                            ...
                            if tenhou == 3:
                                count += 1             
                                df.loc[str(count)] = [tsumohai,tehai3_m,tehai3_m2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 3:
                                count += 1                  
                                df.loc[str(count)] = [tsumohai,tehai3_p,tehai3_p2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 3:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai3_s,tehai3_s2,'1']
                                df.to_csv(csv)
                            ...
                            if tenhou == 3:
                                count += 1                   
                                df.loc[str(count)] = [tsumohai,tehai3_j,tehai3_j2,'1']
                                df.to_csv(csv)
